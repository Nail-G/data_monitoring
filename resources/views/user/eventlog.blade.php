                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="/event-log-user">Data Table Log</a></li>
                        </ol>
                    </div>
                </div>      
        ...
        {{-- bordered table --}}
         ...
         <div class="col-lg-12">
                    <div class="card">
                        ...
                        <a href="{{ route ('exportdataus')}}"class="btn btn-success">Export</a>
                        </div>
                        <form action="/event-log-user" method="GET">
                            <div class="mb-2 mt-3" style="padding-left: 2%">
                                <label class="form-label" style="color: black">Search</label>
                                <input style="width: 20%" type="search" name="carii" class="form-control"
                                    placeholder="Office ID OR  Branch ID" value="{{ $request->carii }}">
                            </div>
                        </form>
                        <div class="card-body">
